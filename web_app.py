...
async function saveExpense() {
  ...
  try {
    ...
    if (data.ok) {
     ...
     const photos = { 'Ποτό': ['/IMG_8312.jpg', '🍻 Cheersss!!!'], 'Delivery': ['/IMG_8379.jpg', '🥐 Πάλι κρέπα;'], 'Ψώνια': ['/IMG_4035.jpg', '🛍️ Slay Queen!'], 'Φαγητό Έξω': ['/IMG_0721.jpg', '🍕 ΜΙΑΜ!'], 'Διάφορα': ['/IMG_3049.jpg', '🤔 Τι πήραμε πάλι;'], 'Συνδρομές': ['/IMG_0214.jpg', '📱 Πάλι συνδρομές...'] };
