...
<div id="photo-overlay" style="display:none;position:fixed;inset:0;background:rgba(0,0,0,0.85);z-index:200;align-items:center;justify-content:center;flex-direction:column;gap:16px;">
  ...
  <div style="color:white;font-family:'Syne',sans-serif;font-size:20px;font-weight:800;">🍻 Cheersss!!!</div>
</div>
...
async function saveExpense() {
  ...
  try {
    ...
    if (data.ok) {
      ...
      if (selectedCat === 'Ποτό' || selectedCat === 'Delivery') { const o = document.getElementById('photo-overlay'); o.style.display='flex'; setTimeout(()=>{ o.style.display='none'; }, 3000); }
